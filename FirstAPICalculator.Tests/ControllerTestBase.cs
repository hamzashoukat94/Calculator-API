...
namespace FirstAPICalculator.Tests
{
    ...
    using FirstAPICalculator.Standard.Models;
    ...
    public class ControllerTestBase
    {
        ...
        /// <summary>
        /// Gets FirstAPICalculatorClient Client.
        /// </summary>
        protected FirstAPICalculatorClient Client { get; private set; }
        ...
        public void SetUp()
        {
            ...
            this.Client = FirstAPICalculatorClient.CreateFromEnvironment().ToBuilder()
