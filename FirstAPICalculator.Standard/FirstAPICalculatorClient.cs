// <copyright file="FirstAPICalculatorClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace FirstAPICalculator.Standard
{
    using System;
    ...
    /// </summary>
    public sealed class FirstAPICalculatorClient : IConfiguration
    {
        ...
        private FirstAPICalculatorClient(
        ...
        /// <summary>
        /// Creates an object of the FirstAPICalculatorClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> FirstAPICalculatorClient.</returns>
        internal static FirstAPICalculatorClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("FIRST_API_CALCULATOR_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = FirstAPICalculator.Standard.Environment.Production;
            ...
            public FirstAPICalculatorClient Build()
            {
                ...
                return new FirstAPICalculatorClient(
                    this.environment,
                    this.authManagers,
                    this.httpClient,
                    this.httpCallBack,
